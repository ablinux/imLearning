...
# 3 "regMappingVoltile.c" 2

# 3 "regMappingVoltile.c"
int a = 0;
...
int main()
{
    ((CAN_CTRL_bit_t *)0x40053000UL)->CAN_EN = 0xE;

    printf("%x\n", ((CAN_CTRL_bit_t *)0x40053000UL)->CAN_CTRL);
}
